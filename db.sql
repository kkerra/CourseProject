...
INSERT INTO `call` VALUES (1,'2024-01-15 10:30:00',245,'успешно','Клиент интересуется подключением интернета и ТВ',1,1),(2,'2024-01-15 11:15:00',180,'успешно','Консультация по тарифам интернета',2,2),(3,'2024-01-15 14:20:00',320,'неуспешно','Клиент не отвечает',1,3),(4,'2024-01-15 16:45:00',560,'успешно','Подключение пакета услуг: интернет + ТВ + роутер',2,4),(5,'2024-01-16 09:10:00',190,'успешно','Запрос на замену роутера на Wi-Fi 6',1,5),(6,'2024-01-16 12:30:00',275,'успешно','Консультация по ТВ-приставкам',2,1),(7,'2024-01-16 15:40:00',420,'успешно','Подключение дополнительной ТВ-приставки',1,2);
...
INSERT INTO `call_service` VALUES (1,1),(4,1),(2,2),(1,3),(4,4),(1,5),(2,5),(4,6),(5,6),(4,7),(6,7),(6,8),(7,8);
...
INSERT INTO `employee` VALUES (1,'Иванов','Алексей','Петрович','ivanov','pass123','ivanov@company.ru',1),(2,'Петрова','Мария','Сергеевна','petrova','pass456','petrova@company.ru',1),(3,'Сидоров','Дмитрий','Игоревич','sidorov','pass789','sidorov@company.ru',1),(4,'Козлова','Ольга','Владимировна','kozlova','pass012','kozlova@company.ru',2);
...
-- Dump completed on 2025-12-02  7:31:18
